...
BLA=zeros((BLA_size,),'''dadapt_mod/dt=(-adapt_mod+np.maximum(I_IT,0))/tau_adaptation_amyg;dV/dt=(-V + np.maximum(I_IT - K_Amyg*adapt_mod,0) + noise())/tau_amyg;U=np.maximum(V,0);I_IT;I_Dop;US;I_Dop_Max;I_LH;U_max;''')

CE=zeros((CE_size,),'''dadapt_exc/dt=(-adapt_exc+np.maximum(I_BLA,0))/tau_adaptation;dV/dt=(-V + np.maximum(I_BLA - K*adapt_exc,0) + noise())/(tau_amyg*2);U=np.maximum(V,0);I_BLA''')

VTA_dop=zeros((VTA_dop_size,), '''dadapt_exc/dt =  (-adapt_exc+np.maximum(I_PPN_RD,0))/tau_adaptation;dV/dt = (-V +np.maximum(I_PPN_RD- K*adapt_exc,0) - I_VTA_GABA  + noise())/tau_dop;U=np.maximum(V,0)+B; I_PPN_RD;I_VTA_GABA''')

PPN_RD=zeros((PPN_RD_size,),'''dadapt_exc/dt =  (-adapt_exc+np.maximum(I_LH+I_CE,0))/tau_adaptation;dV/dt= (-V + np.maximum(I_LH+I_CE- K_PPN*adapt_exc,0)+ noise())/tau_ppn;U=np.maximum(V,0);I_LH;I_CE''')

VTA_GABA=zeros((VTA_GABA_size,),'''dV/dt= (-V + np.maximum(I_PPN_FT-I_NAc,0) + noise())/(tau_ppn);U=np.maximum(V,0);I_NAc;I_PPN_FT''')

PPN_FT=zeros((PPN_FT_size,),'''dV/dt=(-V+np.maximum(I_CE+U-I_PPN_RD,0))/(tau_ppn);U=np.maximum(V,0);I_CE;I_PPN_RD''')

#Working?
NAc=zeros((NAc_size),'''dadapt_exc/dt =  (-adapt_exc+I_LH)/tau_adaptation;dV/dt=(I_OFC- V*adapt_exc)/tau_NAc;U=np.maximum(np.ceil(I_OFC-adapt_exc)-np.clip(V,0,1),0);I_LH;I_OFC;NAc_max;Bound;Value;check;I_Dop;US''')
...
Y=SparseConnection(IT('V'),BLA('I_IT'),np.full((BLA_size,IT_size),.01),'dW/dt=(post.US*mag_learning_rate*pre.V*np.maximum(post.I_LH-post.U_max,0))')
...
def main(args):
    ...
    with open("IT_record.csv", "ab") as f:
        np.savetxt(f, IT_record[trial_num - 1], delimiter=',', fmt='%f',newline=" ")
        print "file save"
        f.write("\n")
    ...
    with open("LH_record.csv", "ab") as f:
    ...
    with open("BLA_record.csv", "ab") as f:
        np.savetxt(f, BLA_record[trial_num - 1], delimiter=',', fmt='%f',newline=" ")
        f.write("\n")
    ...
    with open("VTA_dop_record.csv", "ab") as f:
    ...
    with open("VTA_GABA_record.csv", "ab") as f:
    ...
    with open("NAc_record.csv", "ab") as f:
        np.savetxt(f, NAc_record[trial_num - 1], delimiter=',', fmt='%f',newline=" ")
        f.write("\n")
    ...
    with open("PPN_RD_record.csv", "ab") as f:
    ...
    with open("PPN_FT_record.csv", "ab") as f:
    ...
    ax0.plot(PPN_RD_record[0],color="orange")
    ax0.set_xlim(0, time)
    ax0.set_ylim(-0.3,2)
    ...
    with open("PPN_RD_0_record.csv", "ab") as f:
        np.savetxt(f, PPN_RD_record[0], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")

    ax1 = plt.subplot2grid((x_size, y_size),(0,1),rowspan=4)
    ax1.plot(PPN_RD_record[6],color="orange")
    ax1.set_xlim(0, time)
    ax1.set_ylim(-0.3, 2)
    ...
    with open("PPN_RD_6_record.csv", "ab") as f:
        np.savetxt(f, PPN_RD_record[6], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")

    ax2 = plt.subplot2grid((x_size, y_size),(0,2),rowspan=4)
    ax2.plot(PPN_RD_record[trial_num - 1],color="orange")
    ax2.set_xlim(0, time)
    ax2.set_ylim(-0.3, 2)
    ...
    with open("PPN_RD_16_record.csv", "ab") as f:
        np.savetxt(f, PPN_RD_record[trial_num-1], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")

    ax3 = plt.subplot2grid((x_size, y_size),(4,0),rowspan=4)
    ax3.plot(PPN_FT_record[0],color="orange")
    ax3.set_xlim(0, time)
    ax3.set_ylim(-0.3, 2)
    ...
    with open("PPN_FT_0_record.csv", "ab") as f:
        np.savetxt(f, PPN_FT_record[0], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")

    ax4 = plt.subplot2grid((x_size, y_size),(4,1),rowspan=4)
    ax4.plot(PPN_FT_record[6],color="orange")
    ax4.set_xlim(0, time)
    ax4.set_ylim(-0.3, 2)
    ...
    with open("PPN_FT_6_record.csv", "ab") as f:
        np.savetxt(f, PPN_FT_record[6], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")

    ax5 = plt.subplot2grid((x_size, y_size),(4,2),rowspan=4)
    ax5.plot(PPN_FT_record[trial_num - 1],color="orange")
    ax5.set_xlim(0, time)
    ax5.set_ylim(-0.3, 2)
    ...
    with open("PPN_FT_16_record.csv", "ab") as f:
        np.savetxt(f, PPN_FT_record[trial_num -1], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")
    ...
    ax6.plot(VTA_dop_record[0],color="red")
    ax6.set_ylim(-0.3, 2)
    ax6.set_xlim(0,time)
    ...
    with open("VTA_dop_0_record.csv", "ab") as f:
        np.savetxt(f, VTA_dop_record[0], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")

    ax7 = plt.subplot2grid((x_size, y_size),(0,1),rowspan=4)
    ax7.plot(VTA_dop_record[6],color="red")
    ax7.set_xlim(0, time)
    ax7.set_ylim(-0.3, 2)
    ...
    with open("VTA_dop_6_record.csv", "ab") as f:
        np.savetxt(f, VTA_dop_record[6], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")

    ax8 = plt.subplot2grid((x_size, y_size),(0,2),rowspan=4)
    ax8.plot(VTA_dop_record[trial_num - 1],color="red")
    ax8.set_xlim(0, time)
    ax8.set_ylim(-0.3, 2)
    ...
    with open("VTA_dop_16_record.csv", "ab") as f:
        np.savetxt(f, VTA_dop_record[trial_num-1], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")

    ax9 = plt.subplot2grid((x_size, y_size),(4,0),rowspan=4)
    ax9.plot(VTA_GABA_record[0],color="red")
    ax9.set_xlim(0, time)
    ax9.set_ylim(-0.3, 2)
    ...
    with open("VTA_GABA_0_record.csv", "ab") as f:
        np.savetxt(f, VTA_GABA_record[0], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")

    ax10 = plt.subplot2grid((x_size, y_size),(4,1),rowspan=4)
    ax10.plot(VTA_GABA_record[6],color="red")
    ...
    with open("VTA_GABA_6_record.csv", "ab") as f:
        np.savetxt(f, VTA_GABA_record[6], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")

    ax11 = plt.subplot2grid((x_size, y_size),(4,2),rowspan=4)
    ax11.plot(VTA_GABA_record[trial_num - 1],color="red")
    ...
    with open("VTA_GABA_16_record.csv", "ab") as f:
        np.savetxt(f, VTA_GABA_record[trial_num-1], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")
    ...
    with open("Max_US_Dop_record.csv", "ab") as f:
        np.savetxt(f, Max_US_Dop_record[0:trial_num - 1], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")
    with open("Max_GABA_Dop_record.csv", "ab") as f:
        np.savetxt(f, Max_GABA_record[0:trial_num - 1], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")
    with open("Max_CS_Dop_record.csv", "ab") as f:
        np.savetxt(f, Max_CS_Dop_record[0:trial_num - 1], delimiter=',', fmt='%f', newline=" ")
        f.write("\n")
